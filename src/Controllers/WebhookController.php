...
The price has been reduced from ".$currency ." ". GeneralHelper::numberFormat($old_price,$currency) ." to ".$currency ." ". GeneralHelper::numberFormat($price,$currency) ." / participant. Enjoy your savings!";
            }
