...
class VertikaltripServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->loadMigrationsFrom(__DIR__.'/migrations/2026_06_09_124233_create_fin_investments_table.php');

        $this->loadMigrationsFrom(__DIR__.'/migrations/2026_06_17_235049_create_orders_shoppingcarts_table.php');
