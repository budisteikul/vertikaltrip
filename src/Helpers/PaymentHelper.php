                                ...
                                <div class="card-img-overlay">
                                    <div class="row h-100">
                                        <div class="col-12 text-center">
                                            ...
                                            <br />
                                            <br />
                                            <a target="_blank" href="https://wise.com/pay/business/vertikaltripllc?amount='. $shoppingcart->shoppingcart_payment->amount .'&currency='. $shoppingcart->shoppingcart_payment->currency .'"><img src="'.config('site.assets').'/img/payment/pww-button.svg"></a>
